...
contract GameCollection is ERC1155, ERC1155URIStorage, Ownable {
    ...
    constructor(address initialOwner, string memory baseURI) ERC1155("") Ownable(initialOwner) {
        _baseURI = baseURI;
    ...
    function setTokenSupplyBatch(uint256[] memory tokenIds, uint256[] memory supplies) external onlyOwner {
